...
load_model_results <- function(data_location, posterior_predictive = FALSE, folder = "modelfit", load_local = TRUE) {
  ...
  if(load_local){
    ...
    if(posterior_predictive){dd_hyperbo_ppc_02 <- readRDS(paste0(dat_path, "/dd_hyperbo_ppc_02.RDS"))}
    ...
    if(posterior_predictive){dd_hyperbo_ppc_03 <- readRDS(paste0(dat_path, "/dd_hyperbo_ppc_03.RDS"))}
    ...
    if(posterior_predictive){dd_hyperbo_ppc_04 <- readRDS(paste0(dat_path, "/dd_hyperbo_ppc_04.RDS"))}
    ...
    if(posterior_predictive){dd_hyperbo_ppc_05 <- readRDS(paste0(dat_path, "/dd_hyperbo_ppc_05.RDS"))}
    ...
    if(posterior_predictive){dd_hyperbo_ppc_06 <- readRDS(paste0(dat_path, "/dd_hyperbo_ppc_06.RDS"))}
  ...
  } else {print("Please set load_local to TRUE to load the data locally.")}
}
